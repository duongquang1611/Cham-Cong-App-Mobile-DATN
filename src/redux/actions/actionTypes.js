...
const SAVE_REPORT_ALL_DATA = 'SAVE_REPORT_ALL_DATA';
const SAVE_REPORT_WORK_DAY_COMPANY = 'SAVE_REPORT_WORK_DAY_COMPANY';
const SAVE_REPORT_ASK_COME_LEAVE_COMPANY = 'SAVE_REPORT_ASK_COME_LEAVE_COMPANY';
const SAVE_REPORT_ASK_DAY_OFF_COMPANY = 'SAVE_REPORT_ASK_DAY_OFF_COMPANY';
const SAVE_LIST_USER_COMPANY = 'SAVE_LIST_USER_COMPANY';
...
export default {
  ...
  // report
  SAVE_REPORT_ALL_DATA,
  SAVE_REPORT_WORK_DAY_COMPANY,
  SAVE_REPORT_ASK_COME_LEAVE_COMPANY,
  SAVE_REPORT_ASK_DAY_OFF_COMPANY,
  SAVE_LIST_USER_COMPANY,
};
